...
namespace İkili_Hesap_Makinesi_Oyunu
{
    public partial class Form1 : Form
    {
        ...
        private void LoadGame()
        {
            ...
            // 
            header.Text = "İkili Hesap Makinesi Oyunu" + Environment.NewLine + "by BALABAN";
            ...
            question.Text = "Binary'de - " + questionNumber + " - nedir?";
        ...
        private void ComboBox_SelectionChangeCommitted(object sender, EventArgs e)
        {
            ...
            lblTotal.Text = "Toplam: " + total + " İkili Sistem:" + binaryCode;

            if (total == questionNumber)
            {

                MessageBox.Show("Doğru! Aferin, şimdi başka bir tane dene", "Balaban Game");
